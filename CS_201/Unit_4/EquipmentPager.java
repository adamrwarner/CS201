...
public class EquipmentPager extends Equipment{
	
	public EquipmentPager(double Weight, double Cost, String Power, String Usage, String Manufacturer, String Electronic){
