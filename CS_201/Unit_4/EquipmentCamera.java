...
public class EquipmentCamera extends Equipment{
	
	public EquipmentCamera(double Weight, double Cost, String Power, String Usage, String Manufacturer, String Electronic){
