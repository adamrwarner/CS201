...
public class EquipmentComputer extends Equipment{
	
	public EquipmentComputer(double Weight, double Cost, String Power, String Usage, String Manufacturer, String Electronic){
